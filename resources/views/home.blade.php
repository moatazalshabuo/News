...
<head>
   ...
   ================================================== -->
    <meta charset="utf-8">
    <title>مجلة جامعة وادي الشاطئ الاخبارية</title>
...
<body id="top">
   ...
   ================================================== -->
    ...
    <h1 class="page-title" style="text-align: right;padding: 55px;
    padding-bottom: 0px;">.مجلة جامعة وادي الشاطئ الاخبارية</h1>
                                    ...
                                    <div class="featured-post-slide">
                                        ...
                                        <div class="post-content">
                                            <ul class="entry-meta">
                                                ...
                                                <li><a
                                                        href="{{ route('cat-single', $news[0]->catogry->id) }}">{{ $news[0]->catogry->name }}</a>
                                                </li>
                                            </ul>
                                ...
                                <div class="entry-header">
                                    ...
                                    <div class="entry-meta">
                                        <span class="cat-links">
                                            <a
                                                href="{{ route('cat-single', $item->catogry->id) }}">{{ $item->catogry->name }}</a>
        ...
        <div class="footer-main">
            ...
            <div class="row">
               ...
               <div class="col-four tab-full mob-full footer-info">
                 ...
                 <h4>مجلة جامعة وادي الشاطئ الاخبارية</h4>
